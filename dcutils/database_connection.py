...
class PostgresData:
    def __init__(self, database_object, dataframe, table_name, on_fields):
        self.database_object = database_object
        self.dataframe = dataframe
        self.database_name = table_name.split(".")[0]
        self.schema_name = table_name.split(".")[1]
        self.table_name = table_name.split(".")[2]
        self.on_fields = on_fields
        self.upd_fields = [field for field in self.dataframe.columns if field not in self.on_fields]
